...
export default function Product() {
    ...
    let array: string[] = db[Number(id)-1]
    return (
        <div className='w-full flex justify-center '>
            <div className='w-[90dvw] h-[50dvh] '>
                <h1 className='text-8xl w-full text-center mt-[5dvh] font-bold'>{array[0]}</h1>
                <div className='w-full mt-[10dvh] h-[50dvh] flex justify-between'>
                    <div className='h-[80dvh] bg-center  bg-no-repeat w-1/2' style={{ backgroundImage: `url(${array[2]})` }}></div>
                    <div className='w-1/2'>
                        <h1 className='text-4xl mt-[5dvh] '>{array[3]}</h1>
                        <div className='bg-white w-full text-6xl my-[5dvh] hover:cursor-pointer hover-scale-115 py-[2dvh] text-black rounded-def text-center'>Add to busket</div>
                    </div>
                </div>
